...
import EGX_DATA_DEFAULT from "./data/egxData.js";

// Use imported EGX dataset by default; prop override is still supported.
...
export default function EGXRecommender({ EGX_DATA = EGX_DATA_DEFAULT }) {
